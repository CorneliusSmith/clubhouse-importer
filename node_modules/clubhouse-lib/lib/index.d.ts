...
declare class Client<RequestType, ResponseType> {
    ...
    /** */
    listEpicStories(epicID: ID): Promise<Array<Story>>;
    /** */
    listEpicComments(epicID: ID): Promise<Array<Comment>>;
    /** */
    getEpic(epicID: ID): Promise<Epic>;
    /** */
    createEpic(params: EpicChange): Promise<Epic>;
    /** */
    createEpicComment(epicID: ID, params: EpicCommentChange): Promise<Comment>;
    /** */
    ...
    /** */
    listMilestoneEpics(milestoneID: ID): Promise<Epic[]>
